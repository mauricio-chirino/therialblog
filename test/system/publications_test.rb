...
class PublicationsTest < ApplicationSystemTestCase
  ...
  test "should create publication" do
    ...
    fill_in "Author", with: @publication.author_id
    fill_in "Category", with: @publication.category_id
    fill_in "Comment", with: @publication.comment
    fill_in "Content", with: @publication.content
    fill_in "Status", with: @publication.status
    fill_in "Tag", with: @publication.tag
